...
void enecginit() {} /* Line 111, Address: 0x1026fc0 */
...
void scr_set() { /* Line 186, Address: 0x1027020 */
...
void playposiset() { /* Line 230, Address: 0x1027210 */
  ...
  if ((unsigned short)xWk >= 161) { /* Line 278, Address: 0x1027394 */
  ...
  if ((unsigned short)yWk >= 97) { /* Line 291, Address: 0x10273fc */
...
void scrbinit(short xWk, short yWk) { /* Line 325, Address: 0x1027500 */
  ...
  if ((unsigned short)scra_v_posit.w.h < 1313) { /* Line 332, Address: 0x1027544 */
...
void scroll() { /* Line 366, Address: 0x10276e0 */
  ...
  scrollz_h(scra_hz * 16, 64); /* Line 399, Address: 0x102780c */
  scrollc_h(scra_hz * 8 * 3, 16); /* Line 400, Address: 0x1027830 */
  scrollb_h(scra_hz * 4 * 3, 4); /* Line 401, Address: 0x102786c */
  ...
  for ( ; i < 78; ++i) { /* Line 455, Address: 0x1027a0c */
    lD2.l = (wD1 << 8) + 32767 + 1; /* Line 456, Address: 0x1027a14 */
  ...
  lD2.w.l = scra_h_posit.w.h - scrb_h_posit.w.h; /* Line 468, Address: 0x1027a64 */
  lD2.w.l <<= 6; /* Line 469, Address: 0x1027a8c */
  lD2.w.l /= 28; /* Line 470, Address: 0x1027a98 */
  lD2.w.l <<= 10; /* Line 471, Address: 0x1027ab8 */
  ...
  for (i = 0; i < 7; ++i) { /* Line 477, Address: 0x1027ae0 */
    ...
    *pHScrollWork-- = lD0.w.l; /* Line 479, Address: 0x1027b08 */
    lD3.l = ((unsigned int)lD3.l >> 16) | (lD3.l << 16 & -65536); /* Line 480, Address: 0x1027b1c */
    lD3.l += lD2.l; /* Line 481, Address: 0x1027b40 */
    lD3.l = ((unsigned int)lD3.l >> 16) | (lD3.l << 16 & -65536); /* Line 482, Address: 0x1027b50 */
  ...
  lD2.l = scra_h_posit.w.h - scrb_h_posit.w.h; /* Line 547, Address: 0x1027e08 */
  ...
  for (i = 0; i < 10; ++i) { /* Line 553, Address: 0x1027e84 */
    *pHScrollWork++ = (unsigned short)-lD3.w.l; /* Line 554, Address: 0x1027e90 */
    lD3.l = ((unsigned int)lD3.l >> 16) | (lD3.l << 16 & -65536); /* Line 555, Address: 0x1027ebc */
    lD3.l += lD2.l; /* Line 556, Address: 0x1027ee0 */
    lD3.l = ((unsigned int)lD3.l >> 16) | (lD3.l << 16 & -65536); /* Line 557, Address: 0x1027ef0 */
  ...
  if (wD1 <= wD3) { /* Line 575, Address: 0x1027ff8 */
    ...
    pHScrollWork += lD0.w.l / 2U; /* Line 583, Address: 0x1028038 */
  ...
  do {
    ...
    if (wD3 <= wD4) { /* Line 608, Address: 0x1028180 */
      ...
      wD3 = (char)awasintbl[wD5]; /* Line 610, Address: 0x10281a0 */
      wD3 += scra_h_posit.w.h; /* Line 611, Address: 0x10281cc */
      wD3 = -wD3; /* Line 612, Address: 0x10281e0 */
...
void scroll_h() { /* Line 744, Address: 0x10286b0 */
  unsigned short wD4;
...
void scrh_move() { /* Line 763, Address: 0x1028790 */
  unsigned short wD0;
...
void right_check(unsigned short wD0) { /* Line 783, Address: 0x1028840 */
  ...
  if ((short)wD0 >= 17) { /* Line 786, Address: 0x102884c */
...
void scroll_v() { /* Line 841, Address: 0x1028a40 */
  unsigned short wD0;
  ...
  if (wD0 != 0) { /* Line 872, Address: 0x1028b80 */
...
void sv_move_main(unsigned short wD0) { /* Line 891, Address: 0x1028be0 */
  ...
  if (scra_vline != 96) { /* Line 894, Address: 0x1028bf0 */
    ...
    if ((short)wD1 < 0) { /* Line 900, Address: 0x1028c2c */
      wD1 = -wD1; /* Line 901, Address: 0x1028c44 */
    }
    ...
    if (wD1 >= 2048) { /* Line 904, Address: 0x1028c60 */
      ...
      if ((short)wD0 >= 7) { /* Line 908, Address: 0x1028c84 */
...
void sv_move_main1(unsigned short wD0) { /* Line 923, Address: 0x1028d10 */
  ...
  if ((short)wD0 >= 3) { /* Line 925, Address: 0x1028d1c */
...
void sv_move_main2(unsigned short wD0) { /* Line 938, Address: 0x1028da0 */
  ...
  if ((short)wD0 >= 17) { /* Line 940, Address: 0x1028dac */
...
void sv_move_sub2() { /* Line 953, Address: 0x1028e30 */
...
void scrollwrtadva() { /* Line 1259, Address: 0x1029840 */
...
void scrollwrt() { /* Line 1291, Address: 0x10298c0 */
  unsigned short wH_posiw, wV_posiw;
  int VramBase;
  POINT TilePoint;
  unsigned char* pScrFlag;
...
label1:
  if (*pScrFlag != 0) { /* Line 1450, Address: 0x1029db8 */
    ...
    if (WrtTblCnt >= 114) WrtTblCnt = 113; /* Line 1468, Address: 0x1029e58 */
...
void scrollwrtc() {} /* Line 1497, Address: 0x1029fb0 */




void scrollwrtz() {} /* Line 1502, Address: 0x1029fc0 */
...
int mapadrset(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1680, Address: 0x102a480 */
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1681, Address: 0x102a4a0 */
...
int mapadrset1(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1684, Address: 0x102a4d0 */
  ...
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1686, Address: 0x102a4f4 */
...
void mapwrt() { /* Line 1928, Address: 0x102ad20 */
  int VramBase;
  unsigned short wH_posiw, wV_posiw;
  unsigned char* pMapWk;
...
void mapwrt_z11a(unsigned char* pMapWk, int VramBase) { /* Line 1974, Address: 0x102aeb0 */
  ...
  do {
    ...
    mapwrt_sub(z32cwrttbl, wD0, wD4, pMapWk, VramBase); /* Line 1985, Address: 0x102af00 */
...
void mapinit() { /* Line 2053, Address: 0x102b0e0 */
...
void mapset() {} /* Line 2090, Address: 0x102b170 */
