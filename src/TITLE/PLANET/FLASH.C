...
void fadein() { /* Line 46, Address: 0x10039f0 */
...
int fadein0_new() { /* Line 73, Address: 0x1003ae0 */
...
static int fadeout_new() { /* Line 144, Address: 0x1003da0 */
...
static int flashin_new() { /* Line 217, Address: 0x1004070 */
...
static int flashout_new() { /* Line 284, Address: 0x1004330 */
...
int FadeProc() { /* Line 335, Address: 0x1004540 */
  int ret;
