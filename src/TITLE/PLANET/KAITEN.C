...
void k_3d() { /* Line 108, Address: 0x1004690 */
  ...
  if (lD0.l & -2147483648) lD0.l <<= 8, lD0.l |= -2147483648; else lD0.l <<= 8; /* Line 122, Address: 0x1004704 */
...
int calc_xt_r() { /* Line 214, Address: 0x1004b60 */
  ...
  if (lD0.l & -2147483648) lD0.l <<= 8, lD0.l |= -2147483648; else lD0.l <<= 8; /* Line 228, Address: 0x1004be4 */
...
int calc_xt_s(int scale) { /* Line 244, Address: 0x1004c60 */
  ...
  if (lD1.l & -2147483648) lD1.l <<= 8, lD1.l |= -2147483648; else lD1.l <<= 8; /* Line 254, Address: 0x1004cd4 */
...
int calc_yt_r() { /* Line 275, Address: 0x1004d60 */
  ...
  if (lD0.l & -2147483648) lD0.l <<= 8, lD0.l |= -2147483648; else lD0.l <<= 8; /* Line 291, Address: 0x1004de4 */
...
int calc_yt_s(int scale) { /* Line 308, Address: 0x1004e60 */
  ...
  if (lD1.l & -2147483648) lD1.l <<= 8, lD1.l |= -2147483648; else lD1.l <<= 8; /* Line 319, Address: 0x1004ed4 */
