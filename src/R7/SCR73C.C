...
void enecginit() {} /* Line 124, Address: 0x1021eb0 */
...
void scr_set() { /* Line 177, Address: 0x1021ed0 */
  int i;
...
void playposiset() { /* Line 205, Address: 0x10220e0 */
...
void scroll() { /* Line 289, Address: 0x1022420 */
  uint_union data;
  int hsCount;
  int i;
...
void scroll_h() { /* Line 478, Address: 0x1022bb0 */
  unsigned short wD4;
...
void scrh_move() { /* Line 497, Address: 0x1022c90 */
  unsigned short wD0;
...
void scroll_v() { /* Line 575, Address: 0x1022f40 */
  unsigned short wD0;
...
void sv_move_sub2() { /* Line 687, Address: 0x1023330 */
...
void scrollwrtadva() { /* Line 992, Address: 0x1023d50 */
...
void scrollwrt() { /* Line 1023, Address: 0x1023e00 */
  unsigned short wH_posiw, wV_posiw;
  int VramBase;
  POINT TilePoint;
  unsigned char* pScrFlag;
...
void scrollwrtc() {} /* Line 1229, Address: 0x1024500 */




void scrollwrtz() {} /* Line 1234, Address: 0x1024510 */
...
int mapadrset(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1410, Address: 0x10249d0 */
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1411, Address: 0x10249f0 */
...
int mapadrset1(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1414, Address: 0x1024a20 */
  ...
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1416, Address: 0x1024a44 */
...
void mapwrt() { /* Line 1658, Address: 0x1025270 */
  int VramBase;
  unsigned short wH_posiw, wV_posiw;
  unsigned char* pMapWk;
...
void mapinit() { /* Line 1781, Address: 0x1025640 */
...
void mapset() {} /* Line 1799, Address: 0x10256a0 */
