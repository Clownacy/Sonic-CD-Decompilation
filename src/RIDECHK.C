// Addresses correspond to R8*.ELF (except R81B.ELF)
#include "EQU.C"
#include "RIDECHK.H"
...
short ride_on_clr(act_info* pActwk, act_info* pPlayerwk) { /* Line 66, Address: 0x1019540 */
  ...
  if ((pActwk - actwk) / 68 != wActwkNo) /* Line 77, Address: 0x10195b0 */
...
short ride_on_set(act_info* pActwk, act_info* pPlayerwk) { /* Line 112, Address: 0x10196f0 */
  ...
  if (byCCR == 1) { /* Line 167, Address: 0x10198e8 */
    ...
    if ((pActwk - actwk) / 68 == wActwkNo) /* Line 170, Address: 0x1019908 */
  ...
  pPlayerwk->actfree[19] = (pActwk - actwk) / 68; /* Line 176, Address: 0x1019978 */
...
short hit_v(act_info* pActwk, act_info* pPlayerwk, short iHitXs, short iHitHs) { /* Line 305, Address: 0x1019e40 */
  ...
  iHitVs = iwk + pActwk->sprvsize + pPlayerwk->sprvsize; /* Line 317, Address: 0x1019ebc */
...
short hit_y(act_info* pActwk, act_info* pPlayerwk, short iHitYs) { /* Line 467, Address: 0x101a3a0 */
  ...
  s2 = pActwk->sprvsize; /* Line 477, Address: 0x101a40c */
  s2 += pPlayerwk->sprvsize; /* Line 478, Address: 0x101a420 */
  ...
  pPlayerwk->yposi.w.h -= s2; /* Line 491, Address: 0x101a4f0 */
...
short hit_yu0(act_info* pActwk, act_info* pPlayerwk, short iHitYs) {/* Line 610, Address: 0x101a900 */
  pPlayerwk->yposi.w.h = pPlayerwk->yposi.w.h - iHitYs;/* Line 611, Address: 0x101a914 */
...
void hit_set(act_info* pActwk, act_info* pPlayerwk) { /* Line 682, Address: 0x101aa90 */
  ...
  pPlayerwk->colino = (pActwk - actwk) / 68; /* Line 720, Address: 0x101ac1c */
