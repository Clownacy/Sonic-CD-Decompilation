...
void scr_set() { /* Line 194, Address: 0x1029f10 */
  short* pScrTbl;
...
static void playposiset() { /* Line 271, Address: 0x102a030 */
...
void scroll() { /* Line 389, Address: 0x102a350 */
  int_union ldwk;
  int_union* pHscrbuf;
  int i;
  int lXwk;
...
static void scroll_h() { /* Line 830, Address: 0x102aeb0 */
  short xwk;
  unsigned char bXwk;
...
static void scrh_move() { /* Line 865, Address: 0x102afa0 */
  short xwk;
...
static void scroll_v() { /* Line 915, Address: 0x102b140 */
  short ywk;
...
static void sv_move_sub2() { /* Line 1056, Address: 0x102b5f0 */
...
static void scrv_up_ch(int_union lSpd) { /* Line 1095, Address: 0x102b690 */
  if (lSpd.w.l <= scralim_up) { /* Line 1096, Address: 0x102b69c */
    if (lSpd.w.l > -256) { /* Line 1097, Address: 0x102b6c4 */
      ...
      actwk[0].yposi.w.l &= 2047; /* Line 1102, Address: 0x102b6fc */
...
static void scrv_down_ch(int_union lSpd) { /* Line 1144, Address: 0x102b7d0 */
  if (lSpd.w.l >= scralim_down) { /* Line 1145, Address: 0x102b7dc */
    if (lSpd.w.l < 2048) { /* Line 1146, Address: 0x102b804 */
      ...
      actwk[0].yposi.w.l &= 2047; /* Line 1151, Address: 0x102b83c */
...
void scrollwrt() { /* Line 1217, Address: 0x102ba00 */
...
void scrollwrtc() {} /* Line 1421, Address: 0x102c100 */




void scrollwrtz() {} /* Line 1426, Address: 0x102c110 */
...
int mapadrset(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1602, Address: 0x102c5d0 */
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1603, Address: 0x102c5f0 */
...
int mapadrset1(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1606, Address: 0x102c620 */
  ...
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1608, Address: 0x102c644 */
...
void mapwrt() { /* Line 1850, Address: 0x102ce70 */
  int VramBase;
  unsigned short wH_posiw;
  unsigned short wV_posiw;
  unsigned char* pMapWk;
...
void mapinit() { /* Line 1982, Address: 0x102d230 */
...
void mapset() {} /* Line 1994, Address: 0x102d2b0 */
...
void enecginit() {} /* Line 2002, Address: 0x102d2d0 */
