...
int __stdcall FUN_004044ee(int param_1, int* param_2, unsigned int param_3, void* param_4) {
  ...
  locals.local_8 = param_2;
  locals.local_18.w.l = ((USHORT*)param_4)[39];
  if (((UCHAR*)param_4)[80] != 0) {
    locals.local_14.w.l = 0;
  }
  else if (locals.local_18.w.l >= 223) {
    return 0;
  }
  else {
    locals.local_14.w.l = locals.local_18.w.l;
  }
  OutputDebugString("Render Go\n");

  for (locals.i.w.l = locals.local_14.w.l; locals.i.w.l < 224; ++locals.i.w.l) {
    // this line is incorrect
    locals.local_c = &locals.local_8[param_3 / 4 * locals.i.w.l];
    *locals.local_c += 0x40404040;
    ++locals.local_c;
    *locals.local_c += 0x40404040;
    ++locals.local_c;
    *locals.local_c += 0x40404040;
...
// 004051e8
int mapinit(short scrahposiw_h, short vscroll_h, short scrahposiw_l, short scrbhposiw_h, short vscroll_l) {
  uint_union i;
  unsigned short posi;
  int effect;
  ...
  posi = scrahposiw_l & 0x1FF;
  DAT_00415100[2].left = 0;
  posi = scrbhposiw_h & 0xFF;
