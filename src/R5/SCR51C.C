...
void enkeichg() { /* Line 151, Address: 0x1023b10 */
...
void scr_set() { /* Line 261, Address: 0x1023d70 */
  short* pScrTbl;
...
static void playposiset() { /* Line 326, Address: 0x1023e90 */
...
void scroll() { /* Line 440, Address: 0x1024160 */
  int_union ldwk;
  int_union* pHscrbuf;
  int i;
  int lXwk;
...
static void scroll_h() { /* Line 869, Address: 0x1024be0 */
  short xwk;
  unsigned char bXwk;
...
static void scrh_move() { /* Line 904, Address: 0x1024cd0 */
  short xwk;
...
static void scroll_v() { /* Line 954, Address: 0x1024e70 */
  short ywk;
...
static void sv_move_sub2() { /* Line 1095, Address: 0x1025320 */
...
void scrollwrt() { /* Line 1256, Address: 0x1025730 */
...
void scrollwrtc() {} /* Line 1461, Address: 0x1025e30 */




void scrollwrtz() {} /* Line 1466, Address: 0x1025e40 */
...
int mapadrset(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1642, Address: 0x1026300 */
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1643, Address: 0x1026320 */
...
int mapadrset1(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1646, Address: 0x1026350 */
  ...
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1648, Address: 0x1026374 */
...
void mapwrt() { /* Line 1890, Address: 0x1026ba0 */
  int VramBase;
  unsigned short wH_posiw, wV_posiw;
  unsigned char* pMapWk;
...
void mapwrtb() { /* Line 1904, Address: 0x1026c20 */
  int VramBase;
  unsigned short wH_posiw, wV_posiw;
  unsigned char* pMapWk;
...
void mapwrt_z81a(unsigned char* pMapWk, int VramBase) { /* Line 1945, Address: 0x1026d90 */
  ...
  do {
    ...
    mapwrt_sub(z81awrttbl, wD0, wD4, pMapWk, VramBase); /* Line 1954, Address: 0x1026de0 */
...
void mapinit() { /* Line 2028, Address: 0x1026fc0 */
...
void mapset() {} /* Line 2072, Address: 0x1027150 */
...
void enecginit() {} /* Line 2080, Address: 0x1027170 */
