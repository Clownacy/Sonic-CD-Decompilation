...
void scr_set() { /* Line 189, Address: 0x102ba90 */
  short* pScrTbl;
...
static void playposiset() { /* Line 264, Address: 0x102bbb0 */
...
void scroll() { /* Line 382, Address: 0x102bef0 */
  int_union ldwk;
  int_union* pHscrbuf;
  int i;
  int lXwk;
...
static void scroll_h() { /* Line 790, Address: 0x102c8b0 */
  short xwk;
  unsigned char bXwk;
...
static void scrh_move() { /* Line 825, Address: 0x102c9a0 */
  short xwk;
...
static void scroll_v() { /* Line 875, Address: 0x102cb40 */
  short ywk;
...
static void sv_move_sub2() { /* Line 1015, Address: 0x102cff0 */
...
void scrollwrt() { /* Line 1176, Address: 0x102d400 */
...
void scrollwrtc() {} /* Line 1380, Address: 0x102db00 */




void scrollwrtz() {} /* Line 1385, Address: 0x102db10 */
...
int mapadrset(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1560, Address: 0x102dfd0 */
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1561, Address: 0x102dff0 */
...
int mapadrset1(unsigned short wH_posiw, unsigned short wV_posiw, unsigned short xOffs, unsigned short yOffs, unsigned char* pMapWk, int* pIndex) { /* Line 1564, Address: 0x102e020 */
  ...
  mapadrset99(wH_posiw, wV_posiw, xOffs, yOffs, pMapWk, pIndex); /* Line 1566, Address: 0x102e044 */
...
void mapwrt() { /* Line 1808, Address: 0x102e870 */
  int VramBase;
  unsigned short wH_posiw;
  unsigned short wV_posiw;
  unsigned char* pMapWk;
...
void mapwrt_z81a(unsigned char* pMapWk, int VramBase) { /* Line 1857, Address: 0x102ea00 */
  ...
  do {
    ...
    mapwrt_sub(z81awrttbl, wD0, wD4, pMapWk, VramBase); /* Line 1866, Address: 0x102ea50 */
...
void mapinit() { /* Line 1940, Address: 0x102ec30 */
...
void mapset() {} /* Line 1952, Address: 0x102ec90 */
...
void enecginit() {} /* Line 1960, Address: 0x102ecb0 */
