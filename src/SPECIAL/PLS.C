...
static spr_array kem00 = { 1, { { -4, -4, 0, 111 } } };
static spr_array kem01 = { 1, { { -4, -4, 0, 112 } } };
static spr_array kem02 = { 1, { { -4, -4, 0, 113 } } };
static sprite_patterns_sp kemuri00 = { 3, 1, { &kem00, &kem01, &kem02 } };
static sprite_patterns_sp* mpkemuri[1] = { &kemuri00 };
static spr_array stn00 = { 1, { { -10, -24, 0, 114 } } };
static spr_array stn01 = { 1, { { -10, -24, 0, 115 } } };
static spr_array stn02 = { 1, { { -10, -24, 8, 116 } } };
static spr_array stn03 = { 1, { { -10, -24, 0, 117 } } };
static spr_array stn04 = { 1, { { -12, -24, 0, 118 } } };
static spr_array stn05 = { 1, { { -12, -24, 16, 118 } } };
static spr_array stn06 = { 1, { { -12, -24, 24, 118 } } };
static spr_array stn07 = { 1, { { -12, -24, 8, 118 } } };
static spr_array stn08 = { 1, { { -8, -16, 0, 119 } } };
static spr_array stn09 = { 1, { { -8, -16, 16, 119 } } };
static spr_array stn0a = { 1, { { -8, -16, 24, 119 } } };
static spr_array stn0b = { 1, { { -8, -16, 8, 119 } } };
...
void player(sprite_status_sp* plwk) { /* Line 49, Address: 0x1009ec0 */
  ...
  zoomwk.ax = *(short*)(plwk->actfree + 2); /* Line 74, Address: 0x100a080 */
  zoomwk.az = *(short*)(plwk->actfree + 6); /* Line 75, Address: 0x100a090 */
...
void play0(sprite_status_sp* plwk) { /* Line 87, Address: 0x100a120 */
  ...
  *(short*)(plwk->actfree + 2) = 128; /* Line 97, Address: 0x100a190 */
...
void play10(sprite_status_sp* plwk) { /* Line 227, Address: 0x100a7e0 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 229, Address: 0x100a800 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 230, Address: 0x100a810 */
...
void play11(sprite_status_sp* plwk) { /* Line 239, Address: 0x100a880 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 241, Address: 0x100a8a0 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 242, Address: 0x100a8b0 */
...
void play12(sprite_status_sp* plwk) { /* Line 251, Address: 0x100a920 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 253, Address: 0x100a940 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 254, Address: 0x100a950 */
...
void play13(sprite_status_sp* plwk) { /* Line 263, Address: 0x100a9c0 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 265, Address: 0x100a9e0 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 266, Address: 0x100a9f0 */
...
void play14(sprite_status_sp* plwk) { /* Line 275, Address: 0x100aa60 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 277, Address: 0x100aa80 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 278, Address: 0x100aa90 */
...
void play15(sprite_status_sp* plwk) { /* Line 287, Address: 0x100ab00 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 289, Address: 0x100ab20 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 290, Address: 0x100ab30 */
...
void play16(sprite_status_sp* plwk) { /* Line 299, Address: 0x100aba0 */
  ...
  *(short*)(plwk->actfree + 6) -= 8; /* Line 301, Address: 0x100abc0 */
  *(short*)(plwk->actfree + 6) &= 511; /* Line 302, Address: 0x100abd0 */
...
void rlmove(sprite_status_sp* plwk) { /* Line 649, Address: 0x100ba50 */
  ...
  if (swdata_pl.b.h & 8) { /* Line 651, Address: 0x100ba6c */
    *(int*)(plwk->actfree + 4) += -393216; /* Line 652, Address: 0x100ba84 */
    *(int*)(plwk->actfree + 4) = (*(int*)(plwk->actfree + 4) << 7) >> 7; /* Line 653, Address: 0x100ba98 */
    rlscrflg |= 8; /* Line 654, Address: 0x100baac */
  }
  if (swdata_pl.b.h & 4) { /* Line 656, Address: 0x100bac0 */
    *(int*)(plwk->actfree + 4) += 393216; /* Line 657, Address: 0x100bad8 */
    *(int*)(plwk->actfree + 4) = (*(int*)(plwk->actfree + 4) << 7) >> 7; /* Line 658, Address: 0x100baec */
...
void rlmove_j(sprite_status_sp* plwk) { /* Line 664, Address: 0x100bb20 */
  ...
  if (swdata_pl.b.h & 4) { /* Line 666, Address: 0x100bb3c */
    *(int*)(plwk->actfree + 4) = -262144; /* Line 667, Address: 0x100bb54 */
    *(int*)(plwk->actfree + 4) = (*(int*)(plwk->actfree + 4) << 7) >> 7; /* Line 668, Address: 0x100bb68 */
    rlscrflg |= 8; /* Line 669, Address: 0x100bb7c */
  }
  if (swdata_pl.b.h & 4) { /* Line 671, Address: 0x100bb90 */
    *(int*)(plwk->actfree + 4) = 262144; /* Line 672, Address: 0x100bba8 */
    *(int*)(plwk->actfree + 4) = (*(int*)(plwk->actfree + 4) << 7) >> 7; /* Line 673, Address: 0x100bbbc */
...
void go_x_plus(sprite_status_sp* plwk, unsigned short cal_plus, short cal_speed) { /* Line 725, Address: 0x100be30 */
  ...
  cal_z_kaku = (unsigned short)(plwk->actfree + 6) + cal_plus; /* Line 729, Address: 0x100be4c */
  ...
  plwk->x_posi.l = (plwk->x_posi.l << 4) >> 4; /* Line 734, Address: 0x100beb4 */
  ...
  plwk->y_posi.l = (plwk->y_posi.l << 4) >> 4; /* Line 738, Address: 0x100bf00 */
...
void plptsel(sprite_status_sp* plwk) { /* Line 769, Address: 0x100c000 */
  ...
  cal_pattblno = tbl[plwk->actfree[16] * 2 & 28 + 2]; /* Line 790, Address: 0x100c138 */
  ...
  plwk->spdcnt = 1; /* Line 794, Address: 0x100c1b4 */
...
void sibuki0(sprite_status_sp* sibukiwk) { /* Line 840, Address: 0x100c340 */
  ...
  *(short*)(sibukiwk->actfree) = 14; /* Line 846, Address: 0x100c384 */
...
void sibuki1(sprite_status_sp* sibukiwk) { /* Line 854, Address: 0x100c3f0 */
  if (--*(short*)(sibukiwk->actfree) != 0) return; /* Line 855, Address: 0x100c3fc */
...
void kemuri0(sprite_status_sp* kemuriwk) { /* Line 899, Address: 0x100c590 */
  ...
  *(short*)(kemuriwk->actfree) = 6; /* Line 907, Address: 0x100c5d4 */
...
void t_stone0(sprite_status_sp* stonewk) { /* Line 969, Address: 0x100c7c0 */
  ...
  *(short*)(stonewk->actfree) = 30; /* Line 975, Address: 0x100c804 */
...
void t_stone1(sprite_status_sp* stonewk) { /* Line 981, Address: 0x100c840 */
  if (--*(short*)(stonewk->actfree) == 0) ++stonewk->exeno; /* Line 982, Address: 0x100c848 */
...
void t_stone2(sprite_status_sp* stonewk) { /* Line 986, Address: 0x100c890 */
  ...
  *(short*)(stonewk->actfree) = 60; /* Line 991, Address: 0x100c900 */
...
void t_stone3(sprite_status_sp* stonewk) { /* Line 997, Address: 0x100c940 */
  if (--*(short*)(stonewk->actfree) == 0) gmclrflg = 1; /* Line 998, Address: 0x100c948 */
