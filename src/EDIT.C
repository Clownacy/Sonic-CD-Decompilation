...
void edit(act_info* pActwk) { /* Line 27, Address: 0x100edd0 */
  ...
  if (swdata1.b.h & 15) { /* Line 44, Address: 0x100ee1c */
    ...
    if (edit_spd >= (8 | 1)) edit_spd = 8; /* Line 47, Address: 0x100ee38 */
  ...
  pActwk->patbase = pEdit_tbl[index]; /* Line 94, Address: 0x100f054 */
  pActwk->sproffset = pEdit_tbl[index].offset; /* Line 95, Address: 0x100f070 */
  pActwk->sprpri = pEdit_tbl[index].sprpri; /* Line 96, Address: 0x100f08c */
  pActwk->patno = pEdit_tbl[index].patno; /* Line 97, Address: 0x100f0a8 */
  edit_user = pEdit_tbl[index].userflag_l; /* Line 98, Address: 0x100f0c4 */
  pActwk->actflg = pEdit_tbl[index].rludrv | 4; /* Line 99, Address: 0x100f0e0 */
  ...
  if (CKey & 128) { /* Line 103, Address: 0x100f114 */
    ...
    if (CKeyTogle != CKey) { /* Line 106, Address: 0x100f124 */
      if (actwkchk(&pActwk2) == 0) { /* Line 107, Address: 0x100f134 */
        ...
        pActwk2->actno = pEdit_tbl[index].actno; /* Line 110, Address: 0x100f160 */
        pActwk2->userflag.b.h = pEdit_tbl[index].userflag_h; /* Line 111, Address: 0x100f17c */
        pActwk2->userflag.b.l = pEdit_tbl[index].userflag_l; /* Line 112, Address: 0x100f198 */
        pActwk2->patno = pEdit_tbl[index].patno; /* Line 113, Address: 0x100f1b4 */
